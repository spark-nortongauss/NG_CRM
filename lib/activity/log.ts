...
const CONTACT_FIELD_LABELS: Record<string, string> = {
  ...
  mobile_1_call_status: "Mobile 1 call status",
  mobile_2_call_status: "Mobile 2 call status",
  mobile_3_call_status: "Mobile 3 call status",
  fixed_number_call_status: "Fixed number call status",
  email_1: "Email 1",
  email_2: "Email 2",
  email_3: "Email 3",
  city: "City",
