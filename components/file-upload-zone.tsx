    ...
    <div className="w-full max-w-3xl mx-auto space-y-6">
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 bg-white dark:bg-ng-dark-card px-4 py-2 rounded-full">
      ...
      {/* File Preview */}
      {files.length > 0 && (
        <div className="bg-white dark:bg-ng-dark-card rounded-xl border border-gray-200 dark:border-ng-dark-elevated p-6 shadow-sm">
            ...
            <div key={index} className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <X className="h-5 w-5 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400" />
                  </button>
                </div>
              </div>
              ...
              {file.status === "error" && file.errorMessage && (
                <div className="flex items-center gap-2 text-sm text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30 px-3 py-2 rounded-lg">
              ...
              {file.status === "success" && file.uploadResponse && (
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm text-green-600 dark:text-green-300 bg-green-50 dark:bg-green-900/30 px-3 py-2 rounded-lg">
                  ...
                  {file.uploadResponse.summary && (
                    <div className="grid grid-cols-4 gap-2 text-xs">
                      <div className="bg-blue-50 dark:bg-blue-900/30 px-3 py-2 rounded-lg text-center">
                        <div className="font-semibold text-blue-900 dark:text-blue-300">
                          {file.uploadResponse.summary.total}
                        </div>
                        <div className="text-blue-600 dark:text-blue-300">Total</div>
                      </div>
                      <div className="bg-green-50 dark:bg-green-900/30 px-3 py-2 rounded-lg text-center">
                        <div className="font-semibold text-green-900 dark:text-green-300">
                          {file.uploadResponse.summary.inserted}
                        </div>
                        <div className="text-green-600 dark:text-green-300">Inserted</div>
                      </div>
                      <div className="bg-yellow-50 dark:bg-yellow-900/30 px-3 py-2 rounded-lg text-center">
                      ...
                      <div className="bg-red-50 dark:bg-red-900/30 px-3 py-2 rounded-lg text-center">
