        ...
        <div className="space-y-6 p-6">
            ...
            <div className="rounded-lg border bg-white shadow-sm overflow-hidden">
                ...
                <div className="overflow-x-auto">
                    <Table className="min-w-[1200px]"> {/* Min width to force scroll */}
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="w-[80px] text-center sticky right-0 bg-white shadow-[-5px_0px_10px_-5px_rgba(0,0,0,0.1)]">Actions</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            {isLoading ? (
